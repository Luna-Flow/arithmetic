...
This repository's documentation must describe the real implementation on the current branch for Luna-Flow/arithmetic. It should stay aligned with the exported surface, repository layout, and release narrative.
